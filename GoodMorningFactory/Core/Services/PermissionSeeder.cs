    ...
    public static class PermissionSeeder
    {
        public static List<Permission> GetAllPermissions()
        {
            return new List<Permission>
            {
                ...
                // *** بداية الإضافة: إضافة صلاحية إرسال الطلب للموافقة ***
                new Permission { Module = "المشتريات", Name = "Purchasing.Requisitions.Submit", Description = "إرسال طلبات الشراء للموافقة" },
                // *** نهاية الإضافة ***
