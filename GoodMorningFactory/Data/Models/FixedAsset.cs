...
// *** الكود الكامل والمصحح - تم تهيئة الحقول النصية لتجنب الخطأ ***
using System;
...
namespace GoodMorningFactory.Data.Models
{
    ...
    public class FixedAsset
    {
        ...
        [Required]
        [MaxLength(100)]
        public string AssetName { get; set; } = string.Empty; // تهيئة

        [MaxLength(50)]
        public string AssetCode { get; set; } = string.Empty; // تهيئة

        public string Description { get; set; } = string.Empty; // تهيئة
