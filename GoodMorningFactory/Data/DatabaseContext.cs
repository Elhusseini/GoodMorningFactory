...
namespace GoodMorningFactory.Data
{
    public class DatabaseContext : DbContext
    {
        ...
        public DbSet<AssetDepreciation> AssetDepreciations { get; set; } // <--- أضف هذا السطر
        ...
        // --- بداية الإضافة الجديدة لوحدة الجودة ---
        public DbSet<QualityParameter> QualityParameters { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // تعريف العلاقة الصحيحة (واحد إلى متعدد) بين الفاتورة وسندات الاستلام
            // هذا السطر يخبر EF أن الفاتورة هي "الأب" وسندات الاستلام هي "الأبناء"
            modelBuilder.Entity<Purchase>()
                .HasMany(p => p.GoodsReceiptNotes)
                .WithOne(g => g.Purchase)
                .HasForeignKey(g => g.PurchaseId)
                .OnDelete(DeleteBehavior.Restrict); // منع حذف الفاتورة إذا كانت مرتبطة بسندات استلام
